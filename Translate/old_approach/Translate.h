...
#include "Resource.h" // f�r die Ressourcen-Makros (z.B. IDD_VTRANS_DIALOG), 
// damit das Projekt kompiliert werden kann
#include "StdAfx.h"
//#include "VTransDlg.h"
#include <vector> // f�r ADVERBVECTOR
#include "Word.hpp"
#include "Token.h" //for PositionCStringVector
//#ifndef TEXT_DEFINED
#include "Text.h" // f�r MarkSentence()
#include "rest.h" //f�r typedef	std::vector<CString> CStringVector;
//#include "EnglishView.h" //f�r TranslateText
#include <string>
#include "xmlwriter.h"
...
//Indizes f�r gebeugte Verformen, Anfang
...
//Indizes f�r gebeugte Verformen, Ende
//Artikel-Arten f�r ein bestimmtes englisches Substantiv:
#define A 1
#define AN 2
#define THE 3
...
static std::string g_arstrInflectedDefiniteArticleForNominative[]={
  _T("der"),//DER Mann ist gro�.
  _T("die"),//DIE Frau ist gro�.
  _T("das"),//DAS Kind ist gro�.
  _T("die")//DIE Kinder sind gro�.
};
...
//Wenn f�r jeden Genus(Geschlecht) definiert, dann m�ssen die jeweiligen 
...
//pEV: ein EnglishView-Objekt wird ben�tigt, um dessen Member-Variable
//m_vecIntPair (ein Vektor) gegebenenfalls Elemente hinzuzuf�gen, die
//zwei integer als Membervariablen haben, die jeweils IDs f�r CComboBox-
//(Kombinationsfeld-)Steuerelemente sind und eine ID ein Subjekt, in dem
//ein "du|ihr|Sie|man" vorkommt und eine ID f�r die gebeugten Verbformen steht.
//Wenn man bei dem einen CComboBox-(Kombinationsfeld-)Steuerelement 
//ausw�hlt, soll dann n�mlich auch in dem zugeh�rigen CComboBox-
//(Kombinationsfeld-)Steuerelement der gleiche Index ausgew�hlt werden.
//pEV wird aber nichts in TranslateEnumerationElement2(const EnumerationElement 
//& ee,EnglishView * pEV,int & nStartID); hinzugef�gt, sondern dient zur 
...
// pEV,int & nStartID); hinzugef�gt, sondern dient zur eventuellen
