  ...
  public:
    ...
    void AddVocabularyAndTranslation( VocabularyAndTranslation * pvoc)
    {
	  ...
	  //Satzes (also ein Aufz�hlungselement des Subjektes zum
  ...
  class SentenceElement // SentenceElement mu� textuell �ber den Subklassen
  { // stehen, alphabetische Ordnung nicht m�glich
  ...
  //															 |				    |
  //															 +-Vergleich--+
  //(in diesem Fall: "older than you"; zu Deutsch: "�lter als du")
  ...
  //MannerEnumerationElement: Ausfz�hlungselement einer Umstandsbestimmung der
  //Art und Weise:
  // "I am intelligent and old."

  //Umstandsbestimmung der Art und Weise: "intelligent and old"
  //1. Aufz�hlungselement einer Umstandsbestimmung der Art und Weise:
  //"intelligent"
  //2. Aufz�hlungselement einer Umstandsbestimmung der Art und Weise:
  //"old"
  ...
  //indem man nach ihr mit "wie" fragt. Beispiel: "Er l�uft langsam." 
  //"Wie l�uft er?" -Umstandsbestimmung der Art und Weise: "langsam" 
  ...
  //Die Klasse "Predicate" gibt es, das es mehrere M�glichkeiten f�r 
  //Pr�dikate  in 1nem Haupt- oder Nebensatz geben kann: "The glasses are 
  //broken." -> "Die Brille ist kaputt." (Pr�dikat: "ist") und "Die Brille
  //wird zerbrochen." (Pr�dikat: "wird zerbrochen")
  //ein Pr�dikat hat - au�er bei der einfachen Zukunft, denn bei der Zukunft
  //wird das "will" als Zeitform angesehen und gespeichert, und bei passiven
  //S�tzen ohne ein modales Hilfsverb - eine gebeugte 
  //Verbform ("gV",gebeugte Verbform im Deutschen, also keinen Infinitiv) 
  //und zus�tzlich kann es noch einen 
  ...
  //des Hilfsverbes "werden"), braucht man daf�r nicht extra eine weitere 
  //Vokabel zu speichern (es sollen nur die N�TIGSTEN Daten gespeichert 
  //werden;die gebeugte Verbform bezieht sich auf das deutsche Pr�dikat):
  //SIMPLE_PRESENT:
  //"I like you." gV: like IPP:keiner ("Ich mag dich.")
  //"I can like you." gV: can IPP: like ("Ich kann dich m�gen.")
  ...
  //FUTURE:
  //"I will like you." gV: keine IPP: like ("Ich werde dich m�gen.")
  ...
  {
  public:
	  //Verneinung (wenn ein "not" im Pr�dikat steht); 0: keine Verneinung
	  //sonst: Verneinung
	  BYTE m_bNegation;
	  //0: Passivsatz sonst: Aktivsatz
	  BYTE m_bActiveClause;
	  //die Zeitform des Pr�dikats von Wert "1" bis Wert "8"
	  //1: SIMPLE_PRESENT 
	  //2: SIMPLE_PAST
	  //3: FUTURE
	  ...
	  //eine gebeugte Verbform ist, die f�r eine korrekte �bersetzung notwendig 
	  ...
	  //von "haben" im Deutschen daf�r braucht), kapselt
	  WordNode * m_pWordNodeWhereTheGermanTranslationIsABendVerb;
	  //ein WordNode-Zeiger, der ein englisches Verb, dessen deutsches Pendant
	  //KEINE gebeugte Verbform ist, die f�r eine korrekte �bersetzung notwendig 
    ...
    //kein "s" angeh�ngt, kann es trotzdem gebeugt sein, n�mlich bei modalen
    //Hilfsverben; es muss 1 gebeugtes Verb
    //in einem g�ltigen Predikat geben).
  ...
  public:
	  ...
	  Gerund * m_pGerund;
	  Place * m_pPlace;
	  Object * m_pObjectFirst; //1tes m�gliches Objekt
    //2tes m�gliches Objekt (nur bei bestimmten Verben, wie "to give": 
    ...
    BYTE 
      //Soll ohne Subjekt und Objekt parsen, damit diese Funktion f�r Relativ-S�tze
      //(The man you liked yesterday: Rel-Satz: "you liked yesterday" und f�r Frage-S�tze, die nach einem
