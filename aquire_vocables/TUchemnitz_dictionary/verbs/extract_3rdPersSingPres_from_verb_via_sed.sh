...
#sed '/.*he.*s.*::.*{v[irt]}.*/!d;/.*{v[irt]}.*/ s/.*he\([^|;:{]*\).*::.*sie\ \([^{|;]*\)\({v[irt]\).*/\1::\2\3_3rdPersSingPres}/g'

#sed '/.*she.*s.*::.*{v[irt]}.*/!d;/.*{v[irt]}.*/ s/.*she\ \([^|s]*\)s.*[|:;].*::.*\({v[irt]\)[^|]*|[^|]*|[^|]*|\ er\/sie\([^|]*\).*/\1s ::\3\2_3rdPersSingPres}/g'
#sed '/.*she.*s.*::.*{v[irt]}.*/!d;/.*{v[irt]}.*/ s/.*she\ \([:alpha:]*\)s.*::.*/\1s/g'
#sed '/.*she\ \([^s]*\)s[\ ;].*::.*{v[irt]}.*/!d;s/.*she\ \([^s]*\)s[\ ;].*::.*/\1s/g'
