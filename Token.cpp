...
PositionCStringVector GetBetween(const PositionCStringVector & pcstrv,int first,int last)
{
#ifdef _DEBUG
	printf("GetBetween ANFANG\n");
#endif
	PositionCStringVector retPCStrVec;
	#ifdef _DEBUG
	...
	#ifdef _DEBUG
	printf("PositionCStringVector GetBetween(const PositionCStringVector & pcstrv,int first,int last) ENDE\n");
#endif
	return retPCStrVec;
}
